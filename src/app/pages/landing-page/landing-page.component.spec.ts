...
describe('LandingPageComponent', () => {
  ...
  it('should render the card section if data available', () => {
    jest
      .spyOn(mockHotelService, 'getHotels')
      .mockReturnValue(of(HOTELS_DATA_STUB));
    fixture.detectChanges();
  ...
  it('should change the value on selection change', () => {
    fixture.detectChanges();
    const select: HTMLSelectElement = el.query(
      By.css('.form-control-dropdown')
    ).nativeElement;
